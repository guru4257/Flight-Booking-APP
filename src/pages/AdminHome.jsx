                    ...
                    <div className='hero__content'>
                        <div className='hero__subtitle d-flex align-items-center'>
                         ...
                         <div className='newsletter__input'>
                            ...
                            <h5>Here is your Way to Control Panel Mr. Admin</h5>
                            <button className='btn newsletter__btn ' onClick={handlesubmit}>Control</button>
                        </div>
                        {/* <p>Using color to add meaning only provides a visual indication, which will not be conveyed to users of assistive technologies – such as screen readers. Ensure that information denoted by the color is either obvious .</p> */} 
                    </div>
                </Col>
                <Col lg='2'>
